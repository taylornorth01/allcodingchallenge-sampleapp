...
# Dump of table dayroutine
# ------------------------------------------------------------

DROP TABLE IF EXISTS `dayroutine`;
...
LOCK TABLES `dayroutine` WRITE;
/*!40000 ALTER TABLE `dayroutine` DISABLE KEYS */;

INSERT INTO `dayroutine` (`id`, `employee_id`, `month`, `exercise_time`, `social_interaction_time`, `work_time`, `sleep_time`) VALUES
